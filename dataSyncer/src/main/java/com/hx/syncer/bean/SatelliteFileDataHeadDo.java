...
public class SatelliteFileDataHeadDo {
    ...
    @Column(name = "sate_name" ,nullable=true)
    private String sate_name ;
    @Column(name = "sate_file_num" ,nullable=true)
    private String sate_file_num ;
    ...
    public String getSate_file_num() {
        return sate_file_num;
    }

    public void setSate_file_num(String sate_file_num) {
        this.sate_file_num = sate_file_num;
    }
