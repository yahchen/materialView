-- Table: public.gm_site_sing_gl

-- DROP TABLE public.gm_site_sing_gl;

CREATE TABLE public.gm_site_sing_gl
(
    ...
    s_d_id SERIAL,
    id SERIAL,
    CONSTRAINT gm_site_sing_gl_pkey PRIMARY KEY (id)
)
WITH (
    OIDS = FALSE
)
...
ALTER TABLE public.gm_site_sing_gl
    OWNER to postgres;