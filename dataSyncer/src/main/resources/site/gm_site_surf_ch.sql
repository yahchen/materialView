-- Table: public.gm_site_surf_ch

-- DROP TABLE public.gm_site_surf_ch;

CREATE TABLE public.gm_site_surf_ch
(
    ...
    s_d_id bigint,
    CONSTRAINT gm_site_surf_ch_pkey PRIMARY KEY (station_id_d)
)
WITH (
    OIDS = FALSE
)
...
ALTER TABLE public.gm_site_surf_ch
    OWNER to postgres;