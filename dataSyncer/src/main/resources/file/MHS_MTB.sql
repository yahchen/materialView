-- Table: public."MHS_MTB"

-- DROP TABLE public."MHS_MTB";


CREATE TABLE "MHS_MTB"
(
  sat_id integer,
  ...
  id bigint NOT NULL,
  CONSTRAINT mhs_mtb PRIMARY KEY (id )
)
WITH (
    OIDS = FALSE
)
