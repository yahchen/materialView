-- Table: public."GNSS_MTA"

-- DROP TABLE public."GNSS_MTA";

CREATE TABLE "GNSS_MTA"
(
  sat_id integer,
  ...
  s_f_id SERIAL,
  id SERIAL,
  CONSTRAINT gnss_mta PRIMARY KEY (id )
)
WITH (
    OIDS = FALSE
)
