-- Table: public."AMSUA_NOAA15"

-- DROP TABLE public."AMSUA_NOAA15";


CREATE TABLE "AMSUA_NOAA15"
(
  sat_id integer,
  ...
  id bigint NOT NULL,
  CONSTRAINT amsua_noaa15 PRIMARY KEY (id )
)
WITH (
    OIDS = FALSE
)
...
ALTER TABLE public."AMSUA_NOAA15"
    OWNER to postgres;
...
DELETE FROM public."AMSUA_NOAA15"
	WHERE <condition>;